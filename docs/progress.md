...
- Resume: rerun the corrected cloud gates before shipping the input fix. Retain the thinking evidence gap until a complete capture or new bounded metadata identifies the actual on-wire value.
